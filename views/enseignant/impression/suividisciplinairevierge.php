...
$corps = '<table cellpadding="3"><thead><tr align="center" style="font-weight:bold"><th width="'.$w[0].'%" border="0.5">Dates</th>'
        ...
        . '<tbody>';
for($i = 1; $i < 13; $i++){
    $corps .= '<tr><td width="'.$w[0].'%" border="0.5"></td><td width="'.$w[1].'%" border="0.5"></td>'
            . '<td width="'.$w[2].'%" border="0.5"></td><td width="'.$w[3].'%" border="0.5"></td>'
            . '<td width="'.$w[4].'%" border="0.5"></td><td width="'.$w[5].'%" border="0.5"></td>'
            . '<td width="'.$w[6].'%" border="0.5"></td></tr>';
}
$corps .= '</tbody></table>';
