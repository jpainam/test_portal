...
$pdf->WriteHTMLCell(100, 0, $x + 140, $y + 5, '<b>'.__t('Annee scolaire').' :</b>' . $_SESSION['anneeacademique']);
$pdf->SetFont("Times", '', 10);
$titre = '<p style="text-align:center"><b>'.__t('BILAN GLOBAL DES RESULTATS').'</b><br>' . $lbl . '</p>';
...
$corps = '<table style="text-align:center" cellpadding="2" border="1"><thead>
    <tr  border ="1"   style="font-weight:bold"  >
        ...
        <td border="1"  width ="' . $cols[2] . '%" rowspan="3" >'.__t('Classe').' </td>';

        //<td border="1"  width ="' . $cols[1] . '%"  rowspan="3">&eacute;leves  <br>class&eacute;s</td>
$corps .='
        <td border="1"  width ="' . $cols[1] . '%" rowspan="3">'.__t('Moy').'  <br>Classe</td>
        <td border="1"  width ="' . $cols[1] . '%" rowspan="3">'.__t('Faible').' <br> '.__t('Moy').'</td>
        <td border="1"  width ="' . $cols[1] . '%" rowspan="3">'.__t('Forte'). ' <br> '.__t('Moy').'</td>
        <td border="1" colspan="2" width ="' . $cols[4] . '%" >'.__t('Moy').' &lt; 7,5 </td>
        <td border="1" colspan="2" width ="' . $cols[4] . '%">'.__t('Moy').' &lt;  10</td>
        <td border="1" colspan="2" width ="' . $cols[4] . '%">'.__t('Moy').' &gt;=10</td>
        <td border="1" colspan="2" width ="' . $cols[4] . '%">'.__t('Moy').' &gt;= 12</td>
        <td border="1" colspan="8" width ="' . ($cols[1] * 7 + $cols[3]) . '%">'.__t('Discipline').'</td>';

        //<td border="1" width ="' . $cols[1] . '%">D&eacute;m</td>
        $corps .= '<td border="1"  width ="' . $cols[3] . '%" rowspan="3" align="center" >'.__t('Effectif').'</td>
      </tr>';
$corps .= '<tr>';
for ($i = 1; $i <= 4; $i++) {
