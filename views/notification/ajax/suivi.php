<?php foreach ($messages as $m) { ?>
    <div style="max-height: 150px; overflow: auto; left: 829px; top: 150px; display: none;font-size: 11px" 
         onmouseout="tooltip_off(<?php echo $m['IDNOTIFICATION']; ?>)" 
         onmouseover="tooltip_stop(<?php echo $m['IDNOTIFICATION']; ?>)"
         class="edt_tooltip" id="tooltip<?php echo $m['IDNOTIFICATION'] ?>">
...
# 325 : Droit pour suppression des messages envoyes
        ...
        foreach ($messages as $m) {
            ...
            . " onclick = \"tooltip_on(event,'" . $m['IDNOTIFICATION'] . "')\" />&nbsp;&nbsp;";
            if (isAuth(325)) {
                echo "<img style='cursor:pointer' src='" . img_delete() . "' "
                        . "onclick=\"supprimerMessageEnvoye(".$m['IDNOTIFICATION'].")\" />";
            } else {
